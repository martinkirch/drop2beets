...
def test_debounce(monkeypatch):
    ...
    def fake_import(lib, paths, query):
        ...
        # the following flag shows that import has started:
        # future events should be ignored
